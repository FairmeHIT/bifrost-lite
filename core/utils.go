...
// IsCodemodeTool reports whether the given tool name belongs to the MCP
// code-mode sandbox. The MCP subsystem has been removed, so no tool is a
// code-mode tool; kept for compatibility with plugins that guard on it.
