...
const (
	...
	BifrostContextKeyReasoningEffortLevels               BifrostContextKey = "bifrost-reasoning-effort-levels"                  // []string (set by bifrost - DO NOT SET THIS MANUALLY) — reasoning effort levels the custom provider's upstream accepts; nil/empty means no clamping
