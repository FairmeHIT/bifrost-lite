...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
	...
	return (
		<button
			...
			aria-label={t("ui.sidebar.toggleSidebar")}
			tabIndex={-1}
			onClick={toggleSidebar}
			title={t("ui.sidebar.toggleSidebar")}
			className={cn(
...
const sidebarMenuButtonVariants = cva(
	"peer/menu-button chamfer-sm flex w-full items-center gap-2 overflow-hidden p-2 text-left text-sm tracking-wide outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-primary focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-primary disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-[linear-gradient(180deg,color-mix(in_srgb,var(--accent-bright)_22%,transparent),color-mix(in_srgb,var(--accent-bright)_6%,transparent))] data-[active=true]:font-semibold data-[active=true]:text-sidebar-primary data-[active=true]:shadow-[inset_0_0_0_1px_color-mix(in_srgb,var(--accent-bright)_45%,transparent)] data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-primary group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
	{
		variants: {
			variant: {
				default: "hover:bg-sidebar-accent hover:text-sidebar-primary",
				outline:
					"bg-background shadow-[0_0_0_1px_var(--sidebar-border)] hover:bg-sidebar-accent hover:text-sidebar-primary hover:shadow-[0_0_0_1px_var(--sidebar-accent)]",
			},
			size: {
				default: "h-8 text-sm",
				sm: "h-7 text-xs",
