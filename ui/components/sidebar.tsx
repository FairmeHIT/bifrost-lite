...
export default function AppSidebar() {
	...
	const items = useMemo(
		() => [
			{
				title: t("sidebar.observability"),
				url: "/workspace/logs",
				icon: Telescope,
				description: t("sidebar.descObservability"),
				...
				subItems: [
					{
						...
						icon: ChartColumnBig,
						description: t("sidebar.descDashboard"),
						hasAccess: hasDashboardAccess,
					},
					{
						title: t("sidebar.llmLogs"),
						url: "/workspace/logs",
						icon: Logs,
						description: t("sidebar.descLlmLogs"),
						hasAccess: hasLogsAccess,
					},
					{
						...
						description: t("sidebar.descConnectors"),
						hasAccess: hasObservabilityAccess,
					},
					{
						title: t("sidebar.logsSettings"),
						url: "/workspace/config/logging",
						icon: Settings,
						description: t("sidebar.descLogsSettings"),
			...
			},
			{
				...
				icon: BoxIcon,
				description: t("sidebar.descModels"),
				hasAccess: true,
				subItems: [
					{
						title: t("sidebar.modelCatalog"),
						url: "/workspace/model-catalog",
						icon: LayoutGrid,
						description: t("sidebar.descModelCatalog"),
						hasAccess: hasModelProvidersAccess,
					},
					{
						title: t("sidebar.modelProviders"),
						url: "/workspace/providers",
						icon: Boxes,
						description: t("sidebar.descModelProviders"),
						hasAccess: hasModelProvidersAccess,
					},
					{
						title: t("sidebar.budgetsAndLimits"),
						url: "/workspace/model-limits",
						icon: Wallet,
						description: t("sidebar.descBudgetsAndLimits"),
						hasAccess: hasGovernanceLegacyAccess,
					},
					{
						title: t("sidebar.routingRules"),
						url: "/workspace/routing-rules",
						icon: Network,
						description: t("sidebar.descRoutingRules"),
						hasAccess: hasRoutingRulesAccess,
					},
					{
						title: t("sidebar.complexityRouter"),
						url: "/workspace/complexity-router",
						icon: GitCompareArrows,
						description: t("sidebar.descComplexityRouter"),
						hasAccess: hasRoutingRulesAccess,
					},
					{
						title: t("sidebar.circuitBreaker"),
						url: "/workspace/circuit-breaker",
						icon: CircuitBoard,
						description: t("sidebar.descCircuitBreaker"),
						hasAccess: hasCircuitBreakerAccess,
					},
					{
						title: t("sidebar.pricingOverrides"),
						url: "/workspace/custom-pricing/overrides",
						icon: SlidersHorizontal,
						description: t("sidebar.descPricingOverrides"),
						hasAccess: hasSettingsAccess,
					},
					{
						title: t("sidebar.modelSettings"),
						url: "/workspace/custom-pricing",
						icon: Settings,
						description: t("sidebar.descModelSettings"),
						hasAccess: hasSettingsAccess,
					},
				],
			},
				...
				subItems: [
					{
						...
						icon: Settings,
						description: t("sidebar.descClientSettings"),
						hasAccess: hasSettingsAccess,
					},
					{
						title: t("sidebar.compatibility"),
						url: "/workspace/config/compatibility",
						icon: Plug,
						description: t("sidebar.descCompatibility"),
						hasAccess: hasSettingsAccess,
					},
					{
						title: t("sidebar.caching"),
					...
					},
					{
						...
						icon: ShieldCheck,
						description: t("sidebar.descSecurity"),
						hasAccess: hasSettingsAccess,
					},
					...(IS_ENTERPRISE
						? [
						...
						: []),
					{
						...
						icon: KeyRound,
						description: t("sidebar.descApiKeys"),
						hasAccess: hasAPIKeyAccess,
					},
					{
						title: t("sidebar.performanceTuning"),
						url: "/workspace/config/performance-tuning",
						icon: TrendingUp,
						description: t("sidebar.descPerformanceTuning"),
						hasAccess: hasSettingsAccess,
					},
					{
						...
						icon: Flag,
						description: t("sidebar.descFeatureFlags"),
