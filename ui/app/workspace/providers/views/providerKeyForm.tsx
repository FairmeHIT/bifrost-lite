	...
	const onSubmit = (value: any) => {
		...
		mutation
			...
			.catch((err) => {
				...
				toast.error(isEditing ? t("providers.keyForm.errorUpdatingKey") : t("providers.keyForm.errorCreatingKey"), {
