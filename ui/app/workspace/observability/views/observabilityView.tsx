...
const supportedPlatformsList = (resolvedTheme: string, t: (path: string) => string): SupportedPlatform[] => [
	{
		id: "otel",
		name: t("observability.openTelemetry"),
		icon: (
						...
						<div className="flex flex-col gap-1">
							...
							{supportedPlatforms.map((tab) => (
								...
								>
									...
									{tab.disabled && (
										<Badge variant="secondary" className="text-muted-foreground ml-auto text-[10px] font-medium">
											{t("observability.comingSoon").toUpperCase()}
										</Badge>
									)}
								</button>
							))}
