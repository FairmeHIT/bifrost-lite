					...
					<div>
						<div className="flex shrink-0 flex-col items-center pt-1 leading-none">
							...
							<div className="mt-1 flex items-center gap-1 text-[11px] text-muted-foreground">
								...
								<Tooltip>
									...
									<TooltipContent side="top">{t("dashboardCharts.externalCacheTooltip")}</TooltipContent>
								</Tooltip>
							</div>
						</div>
						<div className="flex shrink-0 flex-wrap items-center justify-center gap-x-4 gap-y-1 pt-2 text-[11px] leading-none">
							<span className="flex items-center gap-1.5">
								...
								<span className="text-primary">{t("dashboardCharts.cachedCount", { count: formatCompactNumber(totalCachedRead) })}</span>
							</span>
							<span className="flex items-center gap-1.5">
