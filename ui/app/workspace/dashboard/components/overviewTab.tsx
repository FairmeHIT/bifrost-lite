	...
	return (
		<>
			...
			<div className="grid grid-cols-1 gap-2 lg:grid-cols-2 2xl:grid-cols-3">
				{/* Log Volume Chart */}
				<ChartCard
					title={t("dashboardCharts.requestVolume")}
				...
				{/* Token Usage Chart */}
				<ChartCard
					title={t("dashboardCharts.tokenUsage")}
				...
				<ChartCard title={t("dashboardCharts.externalCacheHitRate")} loading={loadingTokens} testId="chart-cache-external">
					<ExternalCacheTokenMeterChart data={tokenData} />
				</ChartCard>

				{/* Local Cache Hit Rate Meter */}
				<ChartCard title={t("dashboardCharts.localCacheHitRate")} loading={loadingStats} testId="chart-cache-local">
					<LocalCacheTokenMeterChart data={logsStats} />
				</ChartCard>

				{/* Cost Chart */}
				<ChartCard
					title={t("dashboardCharts.cost")}
					loading={loadingCost}
											...
											<Tooltip>
												<TooltipTrigger asChild>
													<span tabIndex={0} data-testid="cost-legend-more-trigger" className="text-muted-foreground cursor-default">
														+{costModels.length - 1} {t("dashboardCharts.more")}
													</span>
												</TooltipTrigger>
												<TooltipContent>
				...
				{/* Model Usage Chart */}
				<ChartCard
					title={t("dashboardCharts.modelUsage")}
											...
											<Tooltip>
												<TooltipTrigger asChild>
													<span tabIndex={0} data-testid="usage-legend-more-trigger" className="text-muted-foreground cursor-default">
														+{usageModels.length - 1} {t("dashboardCharts.more")}
													</span>
												</TooltipTrigger>
												<TooltipContent>
													<div className="flex flex-col gap-1">
				...
				{/* Latency Chart */}
				<ChartCard
					title={t("dashboardCharts.latency")}
				...
				<ChartCard
					title={t("dashboardCharts.throughput")}
					...
					legend={
						<div className={CHART_HEADER_LEGEND_CLASS}>
							<span className="flex items-center gap-1">
								...
								<span className="text-muted-foreground">{t("dashboardCharts.tokensPerSec")}</span>
							</span>
						</div>
					}
					controls={
