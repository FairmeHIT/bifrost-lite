	...
	return (
		<main className="h-base flex items-center justify-center p-6">
			<div className="mx-auto w-full max-w-md text-center">
				...
				<h1 className="text-foreground mt-4 text-2xl font-semibold">{t("errorPage.notFoundHeading")}</h1>
				<p className="text-muted-foreground mt-2 text-sm">{t("errorPage.notFoundDescription")}</p>
